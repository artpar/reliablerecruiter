...
const HomePage: React.FC = () => {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold ">ReliableRecruiter.Space</h1>
      ...
      <div className="mt-12 bg-neutral-50 p-6 rounded-lg border border-neutral-200">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-md border border-neutral-200">
            ...
            <p className="text-sm  mt-1">Import your existing files or paste text directly into the tools.</p>
          </div>
          <div className="bg-white p-4 rounded-md border border-neutral-200">
            <div className="text-primary-600 mb-2">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="font-medium ">Process and Analyze</h3>
            <p className="text-sm  mt-1">The tools automatically process your data and generate insights.</p>
          </div>
          <div className="bg-white p-4 rounded-md border border-neutral-200">
            <div className="text-primary-600 mb-2">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-sm  mt-1">Download your results or adjusted data for immediate use.</p>
          </div>
        </div>
      </div>
    </div>
